            ...
            ElevatedButton(
              onPressed: (){
                if(_formKey.currentState!.validate()){
                  ...
                  Provider.of<TimeEntryProvider>(context, listen: false).addTimeEntry(TimeEntry(id: DateTime.now().toString(), projectId: projectId, taskId: taskId, totalTime: totalTime, date: date, notes: notes));
